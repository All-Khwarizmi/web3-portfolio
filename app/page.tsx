...
import { Github, Linkedin, Mail, Twitter, Code, Shield, ChevronRight, Terminal } from "lucide-react"
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center mb-4">
                    ...
                    <div className="flex justify-center space-x-3">
                      <SocialLink icon={<Github size={18} />} href="https://github.com/All-Khwarizmi" />
                      <SocialLink icon={<Twitter size={18} />} href="https://twitter.com/swarecito" />
                      <SocialLink icon={<Linkedin size={18} />} href="https://www.linkedin.com/in/jason-suarez/" />
                      <SocialLink icon={<Mail size={18} />} href="mailto:contact@jason-suarez.com" />
                    </div>
                  </div>

                  {/* Token Stats */}
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    <TokenValue label="Audits" value="32" />
                    <TokenValue label="Vulns Found" value="127" />
                    <TokenValue label="Projects" value="18" />
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center mb-2">
                      ...
                      <h3 className="text-sm font-mono text-cyan-400">SKILLS</h3>
                    </div>
                    <HexGrid />
                  </div>
                </CardContent>
              ...
              <Card className="border-purple-900/30 backdrop-blur-md bg-black/30 overflow-hidden">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-lg font-mono text-purple-400">FEATURED PROJECTS</h2>
                  </div>
          ...
          <Card className="border-purple-900/30 backdrop-blur-md bg-black/30 overflow-hidden mb-6">
            ...
            <CardContent className="p-0">
              <div className="flex items-center p-2 border-b border-gray-800">
                ...
                <h2 className="text-sm font-mono text-cyan-400">INTERACTIVE TERMINAL</h2>
              </div>
              <InteractiveTerminal />
            </CardContent>
          </Card>
...
function Web3ProjectCard({ title, description, icon, link, demoLink, tags, color }: Web3ProjectCardProps) {
  const colorClasses = {
    cyan: "from-cyan-500/20 to-cyan-900/5 border-cyan-700/30 hover:border-cyan-500/50",
    purple: "from-purple-500/20 to-purple-900/5 border-purple-700/30 hover:border-purple-500/50",
    green: "from-green-500/20 to-green-900/5 border-green-700/30 hover:border-green-500/50",
    amber: "from-amber-500/20 to-amber-900/5 border-amber-700/30 hover:border-amber-500/50",
  ...
  return (
    <div className={cn("rounded-lg p-4 border bg-gradient-to-br transition-all duration-300", colorClasses[color])}>
      <div className="flex items-start mb-3">
        <div className={cn("p-2 rounded-md bg-black/30 mr-3", iconColorClasses[color])}>{icon}</div>
        <div>
          <h3 className={cn("font-mono text-base mb-1", iconColorClasses[color])}>{title}</h3>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button asChild size="sm" className={cn("h-7 px-2 text-xs", iconColorClasses[color])}>
